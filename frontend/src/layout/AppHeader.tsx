...
const routeTitleMap: Record<string, string> = {
  ...
  "/candidates/new": "Novo Candidato",
  "/jobs": "Vagas",
  "/jobs/create": "Nova Vaga",
...
const AppHeader: React.FC = () => {
  ...
  const pageTitle = (() => {
    ...
    if (/^\/candidates\/[^/]+\/edit$/.test(location.pathname)) return "Editar Candidato";
    if (/^\/jobs\/[^/]+$/.test(location.pathname)) return "Detalhe da Vaga";
    return "Dashboard";
  })();
  ...
  return (
    <header className="sticky top-0 flex flex-col w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      ...
      <div className="px-4 py-3 border-t border-gray-100 dark:border-gray-800 lg:px-6">
